...
#define SEARCH_CHAN				// Determines whether to use a defined channel, or search for best channel
//#define DUPL_CHECK				// Determines whether to check for duplicate addresses by sending periodic checks
...
#define ADDR_CHECK_INTERVAL			60000			// Interval between checking for duplicate addresses
#define COMMAND_TIMEOUT_INTERVAL	10000			// Number of mS to wait for a command before switching to local mode
#define CHANNEL_SCAN_INTERVAL		2000			// Dwell time on each channel while in local mode
#define LED_ANIMATION_INTERVAL		62				// Number of mS between changes to the LED pattern if not static
...
HAL_GPIO_PIN(hbLED1, E, 4)						// This is the LED near the antenna on the board
...
HAL_GPIO_PIN(hbLED1, G, 1)						// This is the LED near the antenna on the board
